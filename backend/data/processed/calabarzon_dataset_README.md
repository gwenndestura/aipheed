...
**Rows:** 1317 articles · **Provinces:** {'Batangas': 365, 'Laguna': 350, 'Cavite': 247, 'Quezon': 204, 'Rizal': 151}
**Distinct cities/municipalities:** 96 of 142 · **barangay-level rows:** 31
**By source:** {'corpus_recall': 1251, 'strict_reanalysis': 66}
...
`calabarzon_dataset_dropped_audit.csv` (removed this run: {'no_food_anchor+no_food_insecurity_topic': 229, 'no_food_insecurity_topic': 123, 'other_region_subject+no_food_anchor+no_food_insecurity_topic': 85, 'no_food_anchor': 62, 'off_topic_energy_foreign_or_culture+no_food_anchor+no_food_insecurity_topic': 31, 'other_region_subject': 28, 'off_topic_energy_foreign_or_culture': 20, 'other_region_subject+no_food_anchor': 17, 'needs_review_weak_signal': 14, 'off_topic_energy_foreign_or_culture+no_food_anchor': 8, 'other_region_subject+off_topic_energy_foreign_or_culture+no_food_anchor+no_food_insecurity_topic': 6, 'no_calabarzon_province+other_region_subject': 6, 'off_topic_energy_foreign_or_culture+no_food_insecurity_topic': 4, 'other_region_subject+off_topic_energy_foreign_or_culture': 4, 'no_calabarzon_province+other_region_subject+no_food_anchor': 1, 'other_region_subject+no_food_insecurity_topic': 1, 'no_calabarzon_province': 1, 'other_region_subject+off_topic_energy_foreign_or_culture+no_food_anchor': 1}).
...
signals) — 0 of 1317 rows, for an optional eyeball.
